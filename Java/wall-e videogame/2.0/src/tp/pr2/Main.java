...
public class Main {
    ...
    */
    ...
    public static void main(String[] args) {
    	...
    	RobotEngine robot = new RobotEngine(new City(citymap), initialPlace, direccion);	//Crea una instancia de robotEngine, que sera nuestro Wall-E

    	if(!robot.initGame(initialPlace))
    	{
    		System.out.println("Error initializing the robot engine");
    	}
    	else
    	{
    		robot.startEngine();
