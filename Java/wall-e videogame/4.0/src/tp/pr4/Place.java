...
public class Place 
{
	...
	public String getDescription() {
		...
		if(this.listOfItems.numberOfItems() <= 0)
			...
			newDescription = newDescription + Constants.LINE_SEPARATOR + Constants.MESSAGE_ITEMS_PLACE;
					newDescription = newDescription + Constants.LINE_SEPARATOR + this.listOfItems.toString();
