...
public class Constants {
	...
	public static final int INITIAL_RECYCLED = 0;
	public static final java.lang.String LINE_SEPARATOR = System.getProperty("line.separator");
	public static final java.lang.String MESSAGE_ITEMS_PLACE = "It contains the following items:";
	...
	public static final java.lang.String MESSAGE_CHANGE_ROOM(Direction direction){ return "...moving to " + direction.name();}
	...
	public static final java.lang.String MESSAGE_DOOR(Direction direction) {return "There is a door in the " + direction + ", but it is closed.";}
	...
	*/
	...
	public static final java.lang.String MESSAGE_WALL(Direction direction){ return "What the hell am I supposed to do going to " + direction.name() + "?";}
