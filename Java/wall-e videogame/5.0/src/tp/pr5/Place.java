...
public class Place implements PlaceInfo
{
	...
	public String getDescription() {
		String newDescription = this.descripcion;
		
		if(this.listOfItems.numberOfItems() <= 0)
			newDescription = newDescription + Constants.LINE_SEPARATOR + "The place is empty. There are no objects to pick";
		else{
			
			newDescription = newDescription + Constants.LINE_SEPARATOR + "The place contains these objects:" + Constants.LINE_SEPARATOR + this.listOfItems.toString();
