...
** Errorcodes del RTC
*/
#define RTC_FAILURE (0x1)  /* Fallo del RTC */
#define RTC_OK      (0x0)  /* RTC correcto */
...
/*
** Chequea el estado de la pila que alimenta el RTC
** escribiendo un valor en un registro y comprobando que se ha almacenado
**
*/
