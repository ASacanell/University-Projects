...
void autoCompletar(tTablero &tablero, tTabla sudokuSolucion, bool &finalizado);
	...
	switch(pedirOpcion())
			{
				...
				break;}
				case '7':	//Autocompletar
				{
					autoCompletar(tablero, sudokuSolucion, finalizado);
				break;}
			}
